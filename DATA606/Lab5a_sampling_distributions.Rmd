...
**The distribution of responses in this sample is pretty much the same as the responses in the population. It goes toward the people who believe that the work scientists does benefits the people.In comparison with the larger data of "global_monitor" variable, I think that,  the sample is reflective of the entire population**
...
**I believe that,my sample proportion won't match the sample proportion of other researcher's sample, since the sample is random and even if we don't set a seed, the results would be different from one to another.**
...
**Sample 2(samp2) is very similar to sample 1(samp1) with a slightly change in people who believes in benefits.I ran samples with sizes of 100 and 1000 and i think that the sample of 100 would provide more accuracy, because the distribution would align more with the data.**
...
**Based on the histogram chart, there is more than 2000 elements in the 'sample_pros50. The sampling distribution is symmetric with a little skew to the right. there is a prominent center at 0.2 or 20%.**
...
**There are 25 observations in the sample_props_small object. Each observation represents a sample proportion which makes the sampling distribution.**
...
**From a sample of size 10, the mean of sampling distribution = 0.23, or 23%; SE of sampling distribution = 0.11, or 11%. A sample size of 50 gives me a mean of sampling distribution = 0.20, or 20%; SE of sampling distribution = 0.06, or 6%.Finally, sample size of 100 gives me a mean of sampling distribution of= 0.20, or 20%; SE or sampling distribution = 0.04 or 4%. The shape of the sampling, mean, and the standard error becomes more condensed,when it approaches to the normal distribution as sample size increases at 5,000 simulations.**
...
**The best point estimate the population proportion of people who think the work scientists do enhances their lives is at 0.8 or 80%.**
...
**The shape of this distribution is skewed to the right, and based on the average of p_hat approximately 80% of the population truly believe that scientists do enhance their lives.**
...
**According to the data analysis and histogram,The data appears symmetrical and closer to normal than the sample size of 15, which was lightly skewed to the right. Also, it seems that are less elements in the sample size of 150, around 450, as opposed to the 500 elements in the sample size of 15.**
...
**Looking at both charts and histograms, I would say that chart 2 has a smaller spread, I might prefer to use a sampling distribution with a small spread **
* * *
