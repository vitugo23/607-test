...
## Introduction
I decided to work with a dataset that contains NYC vaccination rates by age, gender, borough, etc. This data contains 15 columns with rich data for this project.
...
## Load Libraries requiered for the project
...
```
### QQ plot of age group fully vaccinated
